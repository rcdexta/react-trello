...
class BoardContainer extends _react.Component {
  ...
  render() {
    const _this$props5 = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props5, ["id", "reducerData", "draggable", "laneDraggable", "laneDragClass", "style", "onDataChange", "addLaneTitle", "editable", "canAddLanes"]); // Stick to whitelisting attributes to segregate board and lane props
