    ...
    return state.lanes.map(function (lane) {
      if (lane.id === laneId) {
        ...
        if (index !== undefined) {
          ...
          cards = (_lane$cards = lane.cards).splice.apply(_lane$cards, [index, 0].concat((0, _toConsumableArray3.default)(newCards)));
        } else {
          cards = [].concat((0, _toConsumableArray3.default)(lane.cards), (0, _toConsumableArray3.default)(newCards));
        }
